...
OMIM_SILVER_STANDARD_DATA_DIR = join(OMIM_SILVER_STANDARD_BASE_DIR, 'data')
OMIM_SILVER_STANDARD_UKB_EFO_MAP_FILE = join(OMIM_SILVER_STANDARD_DATA_DIR, 'UK_Biobank_master_file.tsv')
OMIM_SILVER_STANDARD_EFO_FILE = join(OMIM_SILVER_STANDARD_DATA_DIR, 'EFO.csv.gz')
OMIM_SILVER_STANDARD_FINAL_FILE = join(OMIM_SILVER_STANDARD_DATA_DIR, 'omim_silver_standard.tsv')
...
GWAS_PARSING_FULL_DIR = join(MISC_RESULTS_BASE_DIR, 'gwas_parsing/full/')

VALIDATION_TRAITS_T2D_BASE_DIR = join(RESULTS_DIR, 't2d')
